...
public class Main {
    static ArrayList<Expression> arrayList = new ArrayList<Expression>();
    ...
    private static String getInformation(Expression expression) {
    ...
    private static String modusPonensCheck(Expression expression) {
